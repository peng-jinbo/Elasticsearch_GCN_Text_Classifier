...
def load_corpus(dataset_str):
    ...
    test_idx_orig = parse_index_file(
        "./data/{}.test.index".format(dataset_str))
    test_size = len(test_idx_orig)
    ...
    return adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask, train_size, test_size, test_idx_orig
